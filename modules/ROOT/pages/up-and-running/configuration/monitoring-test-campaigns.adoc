...
monitoring{ all() } 
----
Be precise when specifying the information to monitor. Recording too much information may overshadow the information that is most important and relevant to your system's behaviors and performance and generate a  overhead on your infrastructure.
