= Embedded [.badge.oss]## ##[.badge.commercial]## ##
It is extremely simple to use QALIPSIS as an embedded service into your existing JVM applications using Gradle.

Before you start, make sure you have read the benefits and limitations of the embedded deployment mode in the xref:up-and-running/choose-deployment-mode.adoc[Choose Deployment Mode] section.
