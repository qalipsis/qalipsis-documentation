...
* A general understanding of the xref:core-concepts.adoc[QALIPSIS Core Concepts].
...
image::Minions - Docker container.png[Minions - Docker container,200,200,align="center"]
...
. Clone or download the bootstrap-project from GitHub: https://github.com/qalipsis/bootstrap-project.
+
...
.. Add the required QALIPSIS plugins in the section `qalipsis { plugins {} }`.
+
For example:
+
[source,kotlin,linenumbers]
...
----
.. Add the dependencies you need for your project.
+
For example:
+
[source,kotlin,linenumbers]
...
. Rename the file `src/main/kotlin/my/bootstrap/MyBootstrapScenario.kt` to better represent your project.
