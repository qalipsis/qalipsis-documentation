...
* `authenticationMode`: authentication options for SMTP server; allowed values are any set of `AuthenticationMode` values: `USERNAME_PASSWORD`, `PLAIN`; defaults to `PLAIN`.
