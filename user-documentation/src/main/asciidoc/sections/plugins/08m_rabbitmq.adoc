...
* `prefetch-count`: defines the prefetch count value; defaults to 10. 
...
* Learn more about `prefetch-count` by reading the  https://www.rabbitmq.com/consumer-prefetch.html[RabbitMQ Prefetch] documentation.
...
.produce {
    ...
    records { _, input ->
        list-of(
            RabbitMq-producer-record(
                exchange = "battery_state",
                routing-key = "battery_state",
                props = null,
