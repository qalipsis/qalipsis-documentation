...
An example scenario that uses a combination of the `rabbitmq` `consume` and `produce` steps is provided on https://github.com/qalipsis/qalipsis-examples/tree/master/rabbitmq[GitHub].
