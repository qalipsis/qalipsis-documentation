...
// insert graphic/screenshot of the Bootstrap QALIPSIS page when available
...
// Do we still want to exclude the following???


// Execute the scenario again; the events file is created and contains the details of the individual failed assertions:
