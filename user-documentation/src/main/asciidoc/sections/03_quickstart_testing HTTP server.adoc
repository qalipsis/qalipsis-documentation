...
== Create a Project
. In your browser, open the website https://bootstrap.qalipsis.io[Bootstrap QALIPSIS].
. Verify that your system has the pre-requisites listed on the https://bootstrap.qalipsis.io[Bootstrap QALIPSIS] page.
...
[ insert graphic/screenshot of the Bootstrap QALIPSIS page ]
