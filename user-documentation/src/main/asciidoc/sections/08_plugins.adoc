...
== Plugin Integration
To create a test scenario, a tiny Gradle/Maven project is required. The plugin is simply added as a dependency to the class path of the project. Refer to link:03_quickstart.adoc[Quickstart] for more information.
...
== Available Plugins
You can  find all  available plugins and their related documentation in the link:08a_available-plugin_overview.adoc[QALIPSIS Available Plugins].
