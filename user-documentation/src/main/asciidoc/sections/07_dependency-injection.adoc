...
class ExecutorFactory {
    ...
    fun simpleExecutor.
    (retryPolicy: RetryPolicy): Executor { // The retry policy is automatically injected into the factory method.
...
The example is for a scenario method, but this can only be used for the constructor of a class declaring scenarios.
