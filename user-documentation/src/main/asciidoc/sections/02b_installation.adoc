...
Note: Open source QALIPSIS OSS does not support native security. For a native secured installation, we encourage you to https://qalipsis.io/#contact[contact] the QALIPSIS team to request a license for QALIPSIS Enterprise. 
...
NOTE::
A high-load cluster is only possible with QALIPSIS Enterprise.  If you are interested in deploying a  high-load cluster, https://qalipsis.io/#contact[contact] the QALIPSIS team to request a license for QALIPSIS Enterprise.
