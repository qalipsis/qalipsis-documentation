...
. A call to the Scenario function:
+
...
@Scenario
fun myScenario()
    val myScenario = scenario("hello-world"){// Scenario default configuration parameter values
    }
----
...
+
* The maximum number of minions launched cannot be more than the `totalmMnions`.
