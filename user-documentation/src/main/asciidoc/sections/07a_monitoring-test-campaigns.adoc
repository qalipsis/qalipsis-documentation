...
* Graphite: Refer to the link:#_graphite-plugin[Graphite plugin] section for details.
* Elasticsearch: Refer to the link:#_elasticsearch-plugin[Elasticsearch plugin] section for details. 
* Apache Kafka: Refer to the link:#_apache-kafka-plugin[Apache Kafka plugin] section for details.  
* TimescaleDB and PostgreSQL: Refer to the link:#_timescaledb-plugin[TimescaleDB plugin] section for details.
* InfluxDB: Refer to the link:#_influxdb-plugin[InfluxDB plugin] section for details.
